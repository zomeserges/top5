...
$(document).ready(function () {
  ...
  // Add direction success
  $('#add_direction_success').on('click', function () {
    toastr.info('Vous avez bien ajouté une nouvelle direction', 'Direction Ajouter', { positionClass: 'toast-top-full-width', });
  });
  // Add direction error
  $('#add_direction_error').on('click', function () {
    toastr.error('Erreur survenue lors de l\'enregistrement ', 'Inconceivable!',{ positionClass: 'toast-top-full-width', });
  });
