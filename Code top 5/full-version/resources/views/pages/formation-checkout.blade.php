      ...
      <section id="place-order" class="list-view product-checkout">
            ...
            <div class="card-content">
              <a href="formation-details">
                <div class="item-img text-center">
                  <img src="{{ asset('images/pages/formation/10.jpg') }}" alt="img-placeholder">
                </div>
                <div class="card-body">
                  <div class="item-name">
        ...
        <div class="card ecommerce-card">
          <div class="card-content">
            <a href="formation-details">
              <div class="item-img text-center">
                <img src="{{ asset('images/pages/formation/2.jpg') }}" alt="img-placeholder">
              </div>
              <div class="card-body">
                <div class="item-name">
        ...
        <div class="card ecommerce-card">
          <div class="card-content">
            <a href="formation-details">
              <div class="item-img text-center">
                <img src="{{ asset('images/pages/formation/3.jpg') }}" alt="img-placeholder">
              </div>
              <div class="card-body">
                <div class="item-name">
        ...
        <div class="card ecommerce-card">
          <div class="card-content">
            <a href="formation-details">
              <div class="item-img text-center">
                <img src="{{ asset('images/pages/formation/4.jpg') }}" alt="img-placeholder">
              </div>
              <div class="card-body">
                <div class="item-name">
        ...
        <div class="card ecommerce-card">
          <div class="card-content">
            <a href="formation-details">
              <div class="item-img text-center">
                <img src="{{ asset('images/pages/formation/5.jpg') }}" alt="img-placeholder">
              </div>
              <div class="card-body">
                <div class="item-name">
        ...
        <div class="card ecommerce-card">
          <div class="card-content">
            <a href="formation-details">
              <div class="item-img text-center">
                <img src="{{ asset('images/pages/formation/7.jpg') }}" alt="img-placeholder">
              </div>
              <div class="card-body">
                <div class="item-name">
