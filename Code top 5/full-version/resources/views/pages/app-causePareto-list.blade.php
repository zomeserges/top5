            ...
            <form>
              <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="causeParetos-list-role">Cause Pareto</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="causeParetos-list-role">
                  ...
                  <div class="form-group">
                    ...
                    <div class='modal fade text-left' id="inlineForm" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Modifier la causePareto </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form  method="post">
                            <div class="modal-body">
                              ...
                              <label>Cause du pareto : </label>
                              <div class="form-group">
                                <input class="form-control" type="text" name="edit_cause" id="edit_causePareto" placeholder="Cause du Pareto" required>
                              </div>
                              <label>Description : </label>
                              <div class="form-group">
                                <textarea class="form-control " name="edit_descriptionCausePareto" id="edit_descriptionCausePareto"></textarea>
                              </div>

                              <div class="form-group">


                                <input class="form-control" type="text" name="edit_pareto" id="edit_pareto" placeholder="Pareto" required>
