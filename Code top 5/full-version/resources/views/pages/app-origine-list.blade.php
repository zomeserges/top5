...
@section('content')
  ...
  <section class="origines-list-wrapper">
    ...
    <div class="card">
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          ...
          @endif
          <div class="origines-list-filter">
            <form>
              <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="origines-list-role">Origine</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="origines-list-role">
    ...
    <!-- origines filter end -->
    <!-- Ag Grid origines list section start -->
                ...
                <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                  <div class="dropdown sort-dropdown mb-1 mb-sm-0">
                    <button class="btn btn-white filter-btn dropdown-toggle border text-dark" type="button"
                      ...
                      1 - 20 of 50
                    </button> &nbsp;&nbsp;&nbsp;<span><a class="btn btn-primary text-white" data-toggle="modal" data-target="#inlineForm1">Add new origine</a></span></h4>
                        ...
                        <div class="modal-content">
                          ...
                          <form action="app-origine-create" method="post">
                            <div class="modal-body">
                              <label>origine : </label>
                              <div class="form-group">
                                <input class="form-control" type="text" name="origine" id="origine" placeholder="Nom de la origine" required>
                              </div>
                            </div>
                            {!! csrf_field() !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class='modal fade text-left' id="inlineForm" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Modifier la origine </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form  method="post">
                            <div class="modal-body">
                              <input class="form-control" type="hidden" name="edit_origine_id" id="edit_origine_id"  placeholder="" required>
                              <label>origine : </label>
                              <div class="form-group">
                                <input class="form-control" type="text" name="edit_origine_name" id="edit_origine_name" placeholder="Nouveau Nom de la origine" required>
                              </div>
                            ...
                            {!! csrf_field() !!}
                            <div class="modal-footer">
                              <button class="btn btn-primary pull-right"  style="margin-top:20px;">Modifier la origine</button>
                              <button type="button"  data-dismiss="modal" aria-label="Close" class="btn btn-danger pull-right " style="margin-top:20px;">Annuler</button>
                            </div>
                          </form>
                        </div>
