...
@section('page-style')
  {{-- Page Css files --}}
  <link rel="stylesheet" href="{{ asset('css/pages/app-info.css') }}">
  <link rel="stylesheet" href="{{ asset(mix('css/pages/aggrid.css')) }}">
@endsection

@section('content')
  <!-- infos list start {{--getInfos()--}}-->

  <section class="infos-list-wrapper">
    <!-- infos filter start -->
    <div class="card">
      <div class="card-header">
        ...
        <div class="heading-elements">
          <ul class="list-inline mb-0">
            ...
            <li><a data-action=""><i class="feather icon-rotate-cw infos-data-filter"></i></a></li>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          <div class="infos-list-filter">
            <form>
              <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="infos-list-role">Role</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="infos-list-role">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="infos-list-status">Status</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="infos-list-status">
                      <option value="">All</option>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="infos-list-verified">Verified</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="infos-list-verified">
                      <option value="">All</option>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="infos-list-department">Department</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="infos-list-department">
                      <option value="">All</option>
    ...
    <!-- infos filter end -->
    <!-- Ag Grid infos list section start -->
    <div id="basic-examples">
      ...
      <!-- Ag Grid infos list section end -->
                        ...
                        <div class="modal-content">
                          ...
                          <form action="#" method="post">
                            <div class="modal-body">
                              ...
                              @endif
                              <input class="form-control" type="hidden" name="info_id" id="edit_info_id" placeholder="info_id" required>
      ...
      @section('page-script')
        ...
        <script src="{{ asset('js/scripts/pages/app-info.js') }}"></script>
