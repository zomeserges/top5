...
@endsection
@include('pages/formation-sidebar')
@section('content')
  <!-- Formation Content Section Starts -->
  ...
  <!-- Formation Search Bar Ends -->

  <!-- Formation Products Starts -->
  <section id="ecommerce-products" class="grid-view">
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/1.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
        ...
        <div class="item-options text-center">
          ...
          <div class="cart">
            <i class="feather icon-shopping-cart"></i> <span class="add-to-cart">Add to cart</span> <a
              href="formation-checkout" class="view-in-cart d-none">View In Cart</a>
          </div>
        </div>
      </div>
    </div>
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/2.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/3.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/4.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/5.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/6.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/7.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/8.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
    ...
    <div class="card ecommerce-card">
      <div class="card-content">
        <a href="formation-details">
          <div class="item-img text-center">
            <img class="img-fluid" src="{{ asset('images/pages/formation/10.jpg') }}" alt="img-placeholder">
          </div>
          <div class="card-body">
            <div class="item-wrapper">
              <div class="item-rating">
  ...
  <!-- Formation Products Ends -->

  <!-- Formation Pagination Starts -->
