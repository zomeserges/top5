...
@section('title', 'Details de la formation')
    ...
    <div class="card">
      <div class="card-body">
        <div class="row mb-5 mt-2">
          <div class="col-12 col-md-7 d-flex align-items-center justify-content-center  mb-md-0">
            <div class="d-flex align-items-center justify-content-center">
              <!--img src="{{ asset('images/elements/macbook-pro.png') }}" class="img-fluid" alt="product image"-->
                <!-- VIDEO -->
                <iframe id="youtube-6601" width="640" height="340" src="https://www.youtube.com/embed/lR5dvxv0qeI" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;
                        picture-in-picture modestbranding=1&amp;disablekb=1&amp;playsinline=1&amp;
                              widget_referrer=http%3A%2F%2F127.0.0.1%3A8000%2Fext-component-plyr&amp;
                              cc_load_policy=0&amp;cc_lang_pref=auto&amp;enablejsapi=1&amp;
                              origin=http%3A%2F%2F127.0.0.1%3A8000&amp;widgetid=1"
                        allowfullscreen="1">
