...
@section('page-style')
  {{-- Page Css files --}}
  <link rel="stylesheet" href="{{ asset('css/pages/app-pdca.css') }}">
  <link rel="stylesheet" href="{{ asset(mix('css/pages/aggrid.css')) }}">
  <link rel="stylesheet" href="{{ asset(mix('css/plugins/extensions/toastr.css')) }}">
@endsection

@section('content')
  <!-- pdcas list start {{--getpdcas()--}}-->
  {{getPdcas()}}
  <section class="pdcas-list-wrapper">
    <!-- pdcas filter start -->
    <div class="card">
        ...
        <h4 class="card-title">Filters
          ...
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              ...
              <li><a data-action=""><i class="feather icon-rotate-cw pdcas-data-filter"></i></a></li>
      ...
      <div class="card-content collapse show">
        <div class="card-body">
          ...
          @endif
          <div class="pdcas-list-filter">
            <form>
              <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                  <label for="pdcas-list-role">PDCA</label>
                  <fieldset class="form-group">
                    <select class="form-control" id="pdcas-list-role">
    ...
    <!-- pdcas filter end -->
    <!-- Ag Grid pdcas list section start -->
    <div id="basic-examples">
                ...
                <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                  <div class="dropdown sort-dropdown mb-1 mb-sm-0">
                    <button class="btn btn-white filter-btn dropdown-toggle border text-dark" type="button"
                      ...
                      1 - 20 of 50
                    </button> &nbsp;&nbsp;&nbsp;<span><a class="btn btn-primary text-white" data-toggle="modal" data-target="#inlineForm1">Add new pdca</a></span></h4>
      ...
      <!-- Ag Grid pdcas list section end -->
    ...
    <!--End add pdca -->
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Ajouter une pdca </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form action="app-pdca-create" method="post">
                            <div class="modal-body">
                              ...
                              <label>pdca : </label>
                              <div class="form-group">
                                <input class="form-control" type="text" name="etat" id="pdca" placeholder="Nom du pdca" required>
                              </div>
                            </div>
                            {!! csrf_field() !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class='modal fade text-left' id="inlineForm" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Modifier le pdca </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form  method="post">
                            <div class="modal-body">
                              <input class="form-control" type="hidden" name="edit_pdca_id" id="edit_pdca_id"  placeholder="" required>
                              <label>pdca : </label>
                              <div class="form-group">
                                <input class="form-control" type="text" name="edit_pdca_name" id="edit_pdca_name" placeholder="Nouveau Nom de la pdca" required>
                              </div>
                            ...
                            {!! csrf_field() !!}
                            <div class="modal-footer">
                              <button class="btn btn-primary pull-right"  style="margin-top:20px;">Modifier la pdca</button>
                              <button type="button"  data-dismiss="modal" aria-label="Close" class="btn btn-danger pull-right " style="margin-top:20px;">Annuler</button>
                            </div>
                          </form>
                        </div>
      ...
      @section('page-script')
        ...
        <script src="{{ asset('js/scripts/pages/app-pdca.js') }}"></script>
