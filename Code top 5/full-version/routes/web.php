...
Route::get('/formation-list', 'FormationController@formation_list');
Route::get('/formation-details', 'FormationController@formation_details');
Route::get('/formation-wishlist', 'FormationController@formation_wishlist');
Route::get('/formation-checkout', 'FormationController@formation_checkout');


// Users Pages
Route::any('/app-user-list', 'UserPagesController@user_list');
Route::get('/app-user-view', 'UserPagesController@user_view');
Route::get('/app-user-edit', 'UserPagesController@user_edit');

// Direction Pages
  Route::get('/app-direction-index', 'UserPagesController@direction_index');
  Route::post('/app-direction-create', 'UserPagesController@direction_create');
  Route::any('/app-direction-list', 'UserPagesController@direction_list');


//SQDIP Pages
  Route::get('/app-sqdip-index', 'UserPagesController@sqdip_index');
  Route::post('/app-sqdip-create', 'UserPagesController@sqdip_create');
  Route::any('/app-sqdip-list', 'UserPagesController@sqdip_list');

  //escalade Pages
  Route::get('/app-escalade-index', 'UserPagesController@escalade_index');
  Route::post('/app-escalade-create', 'UserPagesController@escalade_create');
  Route::any('/app-escalade-list', 'UserPagesController@escalade_list');

  //pdca Pages
  Route::get('/app-pdca-index', 'UserPagesController@pdca_index');
  Route::post('/app-pdca-create', 'UserPagesController@pdca_create');
  Route::any('/app-pdca-list', 'UserPagesController@pdca_list');


//gid Pages
  Route::get('/app-gid-index', 'UserPagesController@gid_index');
  Route::post('/app-gid-create', 'UserPagesController@gid_create');
  Route::any('/app-gid-list', 'UserPagesController@gid_list');
...
//origine Pages
  Route::get('/app-origine-index', 'UserPagesController@origine_index');
